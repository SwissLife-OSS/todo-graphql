...
namespace SwissLife.OSS.TodoGraphQL.Client
{
    ...
    public static class TodoAppClientServiceCollectionExtensions
    {
        private const string _clientName = "TodoAppClient";

        public static IOperationClientBuilder AddTodoAppClient(
            this IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<ITodoAppClient, TodoAppClient>();
            ...
            IOperationClientBuilder builder = serviceCollection.AddOperationClientOptions(_clientName)
                .AddValueSerializer(() => new TodoStatusValueSerializer())
                .AddResultParser(serializers => new GetResultParser(serializers))
